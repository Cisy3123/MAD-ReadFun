...
public class BookListActivity extends AppCompatActivity {
    private final Context mContext = BookListActivity.this;
    private RecyclerView bookListView;
    private Button back;
    private final ArrayList<BookInfo> bookInfoList = new ArrayList<>();
    private String type;

    private final BookInfo[] allanBookList = {new BookInfo("https://img1.doubanio.com/view/subject/l/public/s29636258.jpg","坠落之前","2017-12","7.5","[美] 诺亚·霍利","天津人民出版社","1"),
    ...
    private final BookInfo[] oscarBookList = {new BookInfo("https://img3.doubanio.com/view/subject/l/public/s28281251.jpg","了不起的盖茨比","2013-9-1","8.5","[美] 弗·司各特·菲茨杰拉德","南海出版公司","1"),
    ...
    private final BookInfo[] maoBookList = {new BookInfo("https://img1.doubanio.com/view/subject/l/public/s31307038.jpg","繁花","2019-1-1","8.4","金宇澄","人民文学出版社","1"),
    ...
    private final BookInfo[] nobelBookList = {new BookInfo("https://img3.doubanio.com/view/subject/l/public/s8492855.jpg","切尔诺贝利的回忆","2012-1","8.5","S·A·阿列克谢耶维奇","凤凰出版社","1"),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BookListAdapter adapter = new BookListAdapter(bookInfoList, "recommend");
    ...
    private void getBookInfo(){
        switch (type){
            ...
            case"nobel":
                ...
                break;
            default:
                ArrayList<BookInfo> searchBookList = (ArrayList<BookInfo>) getIntent().getSerializableExtra("bookInfos");
